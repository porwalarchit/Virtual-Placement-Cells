...
function Application() {
  return (
    <Row style={{backgroundColor:" rgba(217, 217, 217, 0.5)",margin:"2%",padding:"2%",borderRadius:"20px"}}>
        ...
        <div><Button className="px-3 py-1" style={{fontSize:"100%",backgroundColor:"rgba(83, 77, 77, 1)",borderRadius:"15px"}}>View College</Button></div>
        </Col>
        ...
        <div><Button className="px-3 py-1" style={{fontSize:"100%",backgroundColor:"red",borderRadius:"15px"}}>Accept</Button></div>
        </Col>
    </Row>
  )
}
