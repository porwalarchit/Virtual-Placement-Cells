  ...
  return (
    ...
    <Row style={{margin:"10% 8%",display:"flex"}} >
        ...
        <Form style={{marginTop:"5%"}}>
            <input placeholder='College Name' style={{paddingLeft:"2%",marginBottom:"2%",border:"none",filter:" drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.25))",width:"70%",height:"45px",borderRadius:"8px"}}/>
