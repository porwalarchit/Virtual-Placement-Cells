  ...
  return (
    ...
    <Row style={{margin:"10% 1%",display:"flex"}} >
        ...
        <Form style={{marginTop:"5%",marginBottom:"2%"}}>
         ...
         <Link to="/companyprofile"><Button style={{padding:"8px 40px",borderRadius:"25px",color:"white",backgroundColor:"black",fontSize:"110%",fontWeight:"bold",fontFamily:"sans-serif"}}>Login</Button></Link>   
        </Form>
        </Col>
